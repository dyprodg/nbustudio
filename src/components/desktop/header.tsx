  ...
  const services = [
    {
      title: "Beratung",
      price: "0CHF",
      description: [`Kostenfreie Beratung`, `Unverbindlich und vor Ort`],
    },
    {
      title: "Recording",
      price: "150CHF",
    ...
    },
    {
      ...
      price: "250CHF",
      description: [
        "Kreative Gestaltung aller Audioelemente für einen harmonischen Gesamtklang, Einsatz fortschrittlicher Mixing-Techniken für erstklassige Resultate",
      ],
    },
    {
  ...
  return (
    <div className="w-[380px] md:w-full flex flex-col items-center overflow-y-hidden">
      ...
      <div className="w-full bg-custom-orange dark:bg-black z-80 relative">
        <video
          src="https://d1m1gpuwwhckwg.cloudfront.net/horizontal-orange.mp4"
          playsInline
          autoPlay
          loop
          muted
          className="mt-12 object-cover w-full z-80 h-[90vh] hidden lg:block"
        />
        <video
          src="https://d1m1gpuwwhckwg.cloudfront.net/vertical-orange.mp4"
          playsInline
          autoPlay
          loop
          muted
          className="mt-16 object-cover w-full h-[80vh] flex lg:hidden"
        />
      </div>
      ...
      <div className="header-container flex flex-col items-center w-full">
        <div className="text-center hidden">
          <FlybyText
            text="Nbu Studio"
            className="text-5xl lg:text-[8rem] font-bold uppercase bg-custom-orange dark:bg-black p-6 rounded-full mt-[-17rem] md:mt-[-8rem] lg:mt-[-12rem] relative z-20"
          />
        </div>
        <div className="flex flex-col md:flex-row w-full justify-between">
          <div className="header-section mt-4 md:mt-20 ml-0 md:ml-auto lg:ml-20 text-center">
            <h2 className="header-title text-3xl md:text-4xl font-bold">
              Professionelle
            </h2>
            <h2 className="header-title text-5xl md:text-5xl lg:text-6xl font-bold uppercase">
              Aufnahmen
            </h2>
          </div>
        ...
        <div className="header-section mt-20 md:mt-[2rem] text-center w-full">
          <h2 className="header-title text-4xl md:text-7xl uppercase">
            Ihr Schweizer
          </h2>
          <p className="header-content text-6xl md:text-[8rem] lg:text-[10rem] font-bold uppercase">
            Tonstudio
          </p>
        </div>
      </div>
          ...
          <div className="services-container m-8 lg:ml-[20px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 relative z-50">
            {services.map((service, index) => (
              ...
              >
                ...
                <div
                  className={`h-[100%] ${index === 4 ? "mt-[4.5rem]" : "mt-[3rem]"}`}
                >
                  <div className="h-[50%]">
