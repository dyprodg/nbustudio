...
export default function Kontakt() {
  ...
  const handleSubmit = async (event: any) => {
    ...
    if (response.message === "Email send successfully") {
      ...
      setError(
        "Senden Fehlgeschlagen. Versuche es später erneut oder schicke eine Nachricht auf WhatsApp unter +41 (0) 78 6381909",
      );
    }
  };
  ...
  return (
    <div
      id="kontakt"
      className="w-full h-screen flex flex-col justify-center items-center text-white relative z-30 md:mt-22 lg:mt-20"
    >
      ...
      <h1 className="text-3xl text-center text-black dark:text-custom-orange m-4">
              ...
              <div className="flex items-center p-2">
                ...
                <span className="ml-2 text-black dark:text-custom-orange">
                  ...
                  <a
                    href="/agb"
                    target="_blank"
                    className="text-black dark:text-custom-orange underline"
                  >
                    AGB
                  </a>{" "}
                  und die{" "}
