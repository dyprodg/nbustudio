      ...
      const restOperation = post({
        ...
        options: {
          ...
          body: {
            ...
            filename: filename,
            ...(imageFilename && {
              imageUrl: `https://d2h4n766jut7m4.cloudfront.net/uploads/${imageFilename}`,
            }),
        ...
        {projects.map((project: any, index: number) => (
          ...
          >
            <button
              ...
              onClick={() =>
                handleDelete(project.postId.S, `uploads/${project.filename.S}`)
              }
            >
              Delete
            </button>
            ...
            <div className="flex flex-col h-full justify-evenly space-y-4 w-full md:w-[30%] m-2">
              ...
              {project.link && (
                <a className="text-xs underline" href={"www.test.de"}>
                  {project.link.S}
                </a>
              )}
            </div>
            ...
            {project.type.S === "video" ? (
              <div className="bg-black border-2 border-black dark:border-custom-orange rounded-2xl ">
                <video
                  className="w-[280px] md:w-[380px] lg:w-[600px] rounded-xl"
                  controls
                >
