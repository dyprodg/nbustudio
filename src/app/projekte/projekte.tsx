        ...
        <div className="flex flex-col items-center mt-20 h-screen">
            ...
            <div className='w-full h-auto flex flex-col items-center space-y-2 mt-8'>
                {projects.map((project: any, index: number) => (
                    ...
                    p-4 border-2 shadow-xl border-black dark:border-custom-orange rounded-lg w-[380px] md:w-[700px] lg:w-[1000px] flex flex-col items-center text-center md:flex-row md:items-end md:text-left justify-between">
